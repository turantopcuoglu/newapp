...
const List<Ingredient> mockIngredients = [
  ...
  Ingredient(
    ...
    name: {'en': 'Lactose-Free Turkish Yogurt', 'tr': 'Laktozsuz Yoğurt'},
    category: IngredientCategory.dairy,
    allergenTags: ['dairy'],
  ),
  Ingredient(
    id: 'soy_milk',
    name: {'en': 'Soy Drink', 'tr': 'Soya İçeceği'},
    category: IngredientCategory.beverage,
    allergenTags: ['soy'],
  ),
  Ingredient(
    id: 'halloumi',
    name: {'en': 'Halloumi', 'tr': 'Hellim'},
    category: IngredientCategory.dairy,
    allergenTags: ['dairy'],
  ),
  Ingredient(
    id: 'gruyere',
    name: {'en': 'Gruyère', 'tr': 'Gravyer'},
    category: IngredientCategory.dairy,
    allergenTags: ['dairy'],
  ),
  Ingredient(
    id: 'string_cheese',
    name: {'en': 'String Cheese', 'tr': 'Telli Peynir'},
    category: IngredientCategory.dairy,
    allergenTags: ['dairy'],
  ),
  Ingredient(
    id: 'whey_protein',
    name: {'en': 'Whey Protein Powder', 'tr': 'Peynir Altı Suyu Proteini'},
    category: IngredientCategory.protein,
    allergenTags: ['dairy'],
  ),
  Ingredient(
    id: 'sucuk',
    name: {'en': 'Sucuk', 'tr': 'Sucuk'},
    category: IngredientCategory.protein,
    allergenTags: [],
  ),
  Ingredient(
    id: 'pastirma',
    name: {'en': 'Pastirma', 'tr': 'Pastırma'},
    category: IngredientCategory.protein,
    allergenTags: [],
  ),
  Ingredient(
    id: 'sausage',
    name: {'en': 'Sausage', 'tr': 'Sosis'},
    category: IngredientCategory.protein,
    allergenTags: [],
  ),
  Ingredient(
  ...
  Ingredient(
    id: 'beef_jerky',
    name: {'en': 'Beef Jerky', 'tr': 'Kurutulmuş Et'},
    category: IngredientCategory.snackFood,
    allergenTags: [],
  ),
  Ingredient(
    id: 'chickpea_flour',
    name: {'en': 'Chickpea Flour', 'tr': 'Nohut Unu'},
    category: IngredientCategory.grain,
    allergenTags: [],
  ),
  Ingredient(
    id: 'lasagna_sheets',
    name: {'en': 'Lasagne Sheets', 'tr': 'Lazanya Yaprağı'},
    category: IngredientCategory.grain,
    allergenTags: ['gluten'],
  ),
  Ingredient(
    id: 'gnocchi',
    name: {'en': 'Gnocchi', 'tr': 'Gnocchi'},
    category: IngredientCategory.grain,
    allergenTags: ['gluten'],
  ),
  Ingredient(
    id: 'ravioli',
    name: {'en': 'Ravioli', 'tr': 'Ravioli'},
    category: IngredientCategory.grain,
  ...
  Ingredient(
    id: 'pizza_dough',
    name: {'en': 'Pizza Dough', 'tr': 'Pizza Hamuru'},
    category: IngredientCategory.grain,
    allergenTags: ['gluten'],
  ),
  Ingredient(
    id: 'quiche_pastry',
    name: {'en': 'Shortcrust Pastry', 'tr': 'Tart Hamuru'},
    category: IngredientCategory.grain,
    allergenTags: ['gluten', 'dairy'],
  ),
  Ingredient(
    id: 'breakfast_cereal',
    name: {'en': 'Whole-Grain Cereal', 'tr': 'Tam Tahıllı Gevrek'},
    category: IngredientCategory.grain,
    allergenTags: ['gluten'],
  ),
  Ingredient(
    id: 'croutons',
    name: {'en': 'Croutons', 'tr': 'Kruton'},
    category: IngredientCategory.grain,
    allergenTags: ['gluten'],
  ),
  Ingredient(
    id: 'rice_paper',
    name: {'en': 'Rice Paper Wrappers', 'tr': 'Pirinç Kâğıdı'},
    category: IngredientCategory.grain,
    allergenTags: [],
  ),
  Ingredient(
    id: 'wheat_berries',
    name: {'en': 'Pearled Wheat', 'tr': 'Aşurelik Buğday'},
    category: IngredientCategory.grain,
    allergenTags: ['gluten'],
  ),
  Ingredient(
    id: 'pak_choi',
    name: {'en': 'Pak Choi', 'tr': 'Pak Choi'},
    category: IngredientCategory.vegetable,
    allergenTags: [],
  ),
  Ingredient(
    id: 'bean_sprouts',
    name: {'en': 'Bean Sprouts', 'tr': 'Fasulye Filizi'},
    category: IngredientCategory.vegetable,
    allergenTags: [],
  ),
  Ingredient(
    id: 'bamboo_shoots',
    name: {'en': 'Bamboo Shoots', 'tr': 'Bambu Filizi'},
    category: IngredientCategory.vegetable,
    allergenTags: [],
  ),
  Ingredient(
    id: 'sugar_snap_peas',
    name: {'en': 'Sugar Snap Peas', 'tr': 'Şeker Bezelye'},
    category: IngredientCategory.vegetable,
    allergenTags: [],
  ),
  Ingredient(
    id: 'sour_cherry',
    name: {'en': 'Sour Cherry', 'tr': 'Vişne'},
    category: IngredientCategory.fruit,
    allergenTags: [],
  ),
  Ingredient(
    id: 'wakame',
    name: {'en': 'Wakame', 'tr': 'Wakame'},
    category: IngredientCategory.vegetable,
    allergenTags: [],
  ),
  Ingredient(
    id: 'kimchi',
    name: {'en': 'Kimchi', 'tr': 'Kimchi'},
    category: IngredientCategory.vegetable,
    allergenTags: [],
  ),
  Ingredient(
    id: 'capers',
    name: {'en': 'Capers', 'tr': 'Kapari'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'chives',
    name: {'en': 'Chives', 'tr': 'Frenk Soğanı'},
    category: IngredientCategory.spice,
    allergenTags: [],
  ),
  Ingredient(
    id: 'radish_sprouts',
    name: {'en': 'Radish Sprouts', 'tr': 'Turp Filizi'},
    category: IngredientCategory.vegetable,
    allergenTags: [],
  ),
  Ingredient(
  ...
  Ingredient(
    id: 'fish_stock',
    name: {'en': 'Fish Stock', 'tr': 'Balık Suyu'},
    category: IngredientCategory.other,
    allergenTags: ['fish'],
  ),
  Ingredient(
    id: 'tomato_sauce',
    name: {'en': 'Tomato Sauce', 'tr': 'Domates Sosu'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'salsa',
    name: {'en': 'Salsa', 'tr': 'Salsa Sosu'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'pesto',
    name: {'en': 'Basil Pesto', 'tr': 'Pesto'},
    category: IngredientCategory.condiment,
  ...
  Ingredient(
    id: 'gochujang',
    name: {'en': 'Gochujang', 'tr': 'Gochujang'},
    category: IngredientCategory.condiment,
    allergenTags: ['soy', 'gluten'],
  ),
  Ingredient(
    id: 'tamari',
    name: {'en': 'Tamari', 'tr': 'Tamari'},
    category: IngredientCategory.condiment,
    allergenTags: ['soy'],
  ),
  Ingredient(
    id: 'fish_sauce',
    name: {'en': 'Fish Sauce', 'tr': 'Balık Sosu'},
    category: IngredientCategory.condiment,
    allergenTags: ['fish'],
  ),
  Ingredient(
    id: 'mirin',
    name: {'en': 'Mirin', 'tr': 'Mirin'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'rice_vinegar',
    name: {'en': 'Rice Vinegar', 'tr': 'Pirinç Sirkesi'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'curry_paste',
    name: {'en': 'Curry Paste', 'tr': 'Köri Ezmesi'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'peanut_sauce',
    name: {'en': 'Peanut Sauce', 'tr': 'Fıstık Sosu'},
    category: IngredientCategory.condiment,
    allergenTags: ['peanuts'],
  ),
  Ingredient(
    id: 'cranberry_sauce',
    name: {'en': 'Cranberry Sauce', 'tr': 'Turna Yemişi Sosu'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'enchilada_sauce',
    name: {'en': 'Enchilada Sauce', 'tr': 'Enchilada Sosu'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
  Ingredient(
    id: 'baked_beans',
    name: {'en': 'Baked Beans', 'tr': 'Domates Soslu Fasulye'},
    category: IngredientCategory.legume,
    allergenTags: [],
  ),
  Ingredient(
    id: 'nutritional_yeast',
    name: {'en': 'Nutritional Yeast', 'tr': 'Besin Mayası'},
    category: IngredientCategory.other,
    allergenTags: [],
  ),
  Ingredient(
    id: 'cacao_nibs',
    name: {'en': 'Cacao Nibs', 'tr': 'Kakao Parçacığı'},
    category: IngredientCategory.snackFood,
    allergenTags: [],
  ),
  Ingredient(
  ...
  Ingredient(
    id: 'garam_masala',
    name: {'en': 'Garam Masala', 'tr': 'Garam Masala'},
    category: IngredientCategory.spice,
    allergenTags: [],
  ),
  Ingredient(
    id: 'cajun_seasoning',
    name: {'en': 'Cajun Seasoning', 'tr': 'Cajun Baharatı'},
    category: IngredientCategory.spice,
    allergenTags: [],
  ),
  Ingredient(
    id: 'star_anise',
    name: {'en': 'Star Anise', 'tr': 'Yıldız Anason'},
    category: IngredientCategory.spice,
    allergenTags: [],
  ),
  Ingredient(
    id: 'sage',
    name: {'en': 'Sage', 'tr': 'Adaçayı'},
    category: IngredientCategory.spice,
    allergenTags: [],
  ),
];
