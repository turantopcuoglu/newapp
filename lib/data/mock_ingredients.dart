...
const List<Ingredient> mockIngredients = [
  ...
  Ingredient(
    id: 'lentils',
    name: {'en': 'Lentils', 'tr': 'Mercimek'},
    category: IngredientCategory.legume,
    allergenTags: [],
  ),
  Ingredient(
    id: 'red_lentils',
    name: {'en': 'Red Lentils', 'tr': 'Kırmızı Mercimek'},
    category: IngredientCategory.legume,
    allergenTags: [],
  ),
  Ingredient(
    id: 'chickpeas',
    name: {'en': 'Chickpeas', 'tr': 'Nohut'},
    category: IngredientCategory.legume,
    allergenTags: [],
  ),
  Ingredient(
    id: 'kidney_beans',
    name: {'en': 'Kidney Beans', 'tr': 'Barbunya'},
    category: IngredientCategory.legume,
    allergenTags: [],
  ),
  Ingredient(
    id: 'black_beans',
    name: {'en': 'Black Beans', 'tr': 'Siyah Fasulye'},
    category: IngredientCategory.legume,
    allergenTags: [],
  ),
  Ingredient(
  ...
  Ingredient(
    id: 'rice_noodles',
    name: {'en': 'Rice Noodles', 'tr': 'Pirinç Eriştesi'},
    category: IngredientCategory.grain,
    allergenTags: [],
  ),
  Ingredient(
    id: 'sardines',
    name: {'en': 'Sardines', 'tr': 'Sardalya'},
    category: IngredientCategory.protein,
    allergenTags: ['fish'],
  ),
  Ingredient(
  ...
  Ingredient(
    id: 'vegetable_oil',
    name: {'en': 'Vegetable Oil', 'tr': 'Sıvı Yağ'},
    category: IngredientCategory.oil,
    allergenTags: [],
  ),
  Ingredient(
  ...
  Ingredient(
    id: 'flaxseeds',
    name: {'en': 'Flaxseeds', 'tr': 'Keten Tohumu'},
    category: IngredientCategory.nut,
    allergenTags: [],
  ),
  Ingredient(
    id: 'vanilla_extract',
    name: {'en': 'Vanilla Extract', 'tr': 'Vanilya Özütü'},
    category: IngredientCategory.condiment,
    allergenTags: [],
  ),
];
